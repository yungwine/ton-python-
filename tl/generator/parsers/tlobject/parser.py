...
def parse_tl(file_path, ignored_ids=CORE_TYPES):
    """
    ...
    with file_path.open() as file:
        ...
        for line in file:
            ...
            try:
                ...
                if all([x not in str(e) for x in ('int ? = Int;', 'long ? = Long', 'double ? = Double;', 'string ? = String;', 'object ? = Object;', 'function ? = Function;', 'bytes data:string = Bytes;', 'true = True;', 'boolTrue = Bool;', 'boolFalse = Bool;', 'vector#1cb5c415 {t:Type} # [ t ] = Vector t;', 'vector {t:Type} # [ t ] = Vector t;', 'int128 4*[ int ] = Int128;', 'int256 8*[ int ] = Int256;')]):
                    raise
